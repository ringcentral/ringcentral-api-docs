...
async function boostrap_test_function(){
  ...
  /*
  await sleep(2000)
  require ('./code-snippets/compliance-export.js')

  await sleep(2000)
  require ('./code-snippets/chats-operations.js')

  await sleep(2000)
  require ('./code-snippets/list-teams.js')
*/
  await sleep(2000)
  require ('./code-snippets/add-team-members.js')
}
