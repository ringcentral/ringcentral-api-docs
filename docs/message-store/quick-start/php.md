...
### Create and Edit message-store.php

Create a file called `message-store.php`. Be sure to edit the variables in ALL CAPS with your app and user credentials.
