...
!!! note "First time sending an SMS?"
    If you are new to RingCentral and are trying to send an SMS for the first time, we recommend you to try our [SMS Quick Start Guide](../../quick-start/) available in multiple languages, but be sure to read our [SMS content policies](../sms-content-policy/) and following best practices as well.
