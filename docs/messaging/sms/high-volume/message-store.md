...
The high volume SMS message store is separate from the Enhanced Business SMS message store. Use the APIs in the table below to access your high volume SMS message store.
