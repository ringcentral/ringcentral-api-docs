# Call Aggerate Reports

It is quite common to acquire and segment analytics data. Call Performance Aggregate API provides ability to aggregate call realted data in various ways such as by summing, averaging, getting minimum or maximum or percetage of data etc. For more information regarding common use cases, please refer to the [overview section](index.md) and for detailed information regarding how to compose API Request, please refer to the data guide below.
