...
<div class="jumbotron pt-1">
  ...
  <p class="lead">The RingCentral Line of Business (LOB) Analytics APIs provide developers access to the data and metrics necessary to help their organizations obtain a deeper understanding of how their team uses RingCentral's voice and telephony services.</p>
  <p>We invite all developers to try out our Analytics API to access key call performance metrics in almost no time. Get started using a Quick Start: in any of the following languages:</p>
