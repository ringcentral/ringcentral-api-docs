...
### Create and Edit fax.rb

Create a file called <tt>fax.rb</tt>. Be sure to edit the variables in ALL CAPS with your app and user credentials. Be sure to also set the recipient's phone number.
