...
<div class="jumbotron pt-1">
  <h2 class="h3 display-5">Let's build your first RingCentral app!</h2>
...
<div class="card-deck">
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      <p class="h5 card-title">SMS</p>
      <p class="h6 card-subtitle mb-2 text-muted">SMS ans Fax API</p>
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      <p class="h5 card-title">Fax</p>
      <p class="h6 card-subtitle mb-2 text-muted">SMS and Fax API</p>
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      <p class="h5 card-title">Making and Controlling Calls</p>
      <p class="h6 card-subtitle mb-2 text-muted">Voice API</p>
...
<div class="card-deck">
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      <p class="h5 card-title">Authentication</p>
      <p class="h6 card-subtitle mb-2 text-muted">Auth API</p>
  ...
  <div class="card" style="width: 18rem;">
    <div class="card-body pt-0 pb-0">
      <p class="h5 card-title">Subscribe to Notifications</p>
      <p class="h6 card-subtitle mb-2 text-muted">Subscription API</p>
...
<div class="card-deck">
  <div class="card">
    <div class="card-body">
      <p class="h5 card-title">API Reference</p>
